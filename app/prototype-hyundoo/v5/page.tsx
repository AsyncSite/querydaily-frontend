  ...
  return (
    <>
      ...
      <div className={styles.container}>
        ...
        {/* Value Proposition Section - 히어로 바로 아래 */}
        <section style={{
          padding: '5rem 2rem',
          ...
          <div style={{maxWidth: '600px', margin: '0 auto'}}>
            <p style={{
              ...
              면접 질문은 <strong style={{color: 'var(--color-secondary)'}}>이력서에서 나옵니다.</strong><br/>
              당신 이력서에서 어떤 질문이 나올지,<br/>
              <strong style={{color: 'var(--color-secondary)'}}>우리가 다 알려드립니다.</strong>
            </p>
            <p style={{
              fontSize: '1.1rem',
              opacity: 0.8,
              ...
              답변 가이드까지 드릴게요.<br/>
              당신은 <strong>하루 10분</strong>만 투자하세요.
            </p>
          </div>
        </section>
          ...
          <div className={styles.problemContainer}>
            ...
            <div style={{maxWidth: '480px', margin: '0 auto'}}>
              ...
              <div style={{marginBottom: '2.5rem'}}>
                ...
                <div style={{display: 'flex', gap: '0.8rem', justifyContent: 'flex-end'}}>
                  <div style={{background: 'rgba(239, 68, 68, 0.12)', padding: '1rem 1.2rem', borderRadius: '12px 0 12px 12px', maxWidth: '85%', borderRight: '3px solid rgba(239, 68, 68, 0.5)'}}>
                    <p style={{fontSize: '1rem', color: 'rgba(0,0,0,0.4)', textAlign: 'center'}}>"<strong>그냥</strong>... 빠르다고 해서요...<br/>주변에서 많이 써서..."</p>
                  </div>
                </div>
              </div>
              ...
              <div style={{marginBottom: '2.5rem'}}>
                ...
                <div style={{display: 'flex', gap: '0.8rem', justifyContent: 'flex-end'}}>
                  <div style={{background: 'rgba(239, 68, 68, 0.12)', padding: '1rem 1.2rem', borderRadius: '12px 0 12px 12px', maxWidth: '85%', borderRight: '3px solid rgba(239, 68, 68, 0.5)'}}>
                    <p style={{fontSize: '1rem', color: 'rgba(0,0,0,0.4)', textAlign: 'center'}}>"음... <strong>국비학원</strong>에서 배워서요...<br/>다들 쓰길래..."</p>
                  </div>
                </div>
              </div>
              ...
              <div style={{marginBottom: '1.5rem'}}>
                ...
                <div style={{display: 'flex', gap: '0.8rem', justifyContent: 'flex-end'}}>
                  <div style={{background: 'rgba(239, 68, 68, 0.12)', padding: '1rem 1.2rem', borderRadius: '12px 0 12px 12px', maxWidth: '85%', borderRight: '3px solid rgba(239, 68, 68, 0.5)'}}>
                    <p style={{fontSize: '1rem', color: 'rgba(0,0,0,0.4)', textAlign: 'center'}}>"그건... <strong>기본값</strong> 쓴 것 같은데...<br/>따로 설정은 안 했어요..."</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className={styles.products}>
          <div className={styles.productsContainer}>
            ...
            <p style={{
              ...
              질문도, 가이드도, 답변 구조도 <strong style={{color: 'var(--color-secondary)'}}>모두 다 준비했습니다.</strong><br/>
              당신은 그냥 열어보기만 하면 됩니다.
            </p>
            ...
            <div id="products" className={styles.pricingGrid}>
              ...
              <div className={`${styles.productCard} ${styles.featured}`}>
                ...
                <p className={styles.planSubtitle}>20일 집중 훈련, 40개 맞춤 질문</p>

                <div className={styles.planDesc}>
                  빅테크·유니콘 출신 시니어 개발자가 직접 검수<br />
                  꼬리질문까지 완벽 대비
                </div>
                ...
                <div className={styles.features}>
                  <div className={styles.feature}>
                    ...
                    <span>하루 2개 질문, 20일 완성 커리큘럼</span>
                  </div>
                  <div className={styles.feature}>
                    <span className={styles.featureCheck}>✓</span>
                    <span>이력서 기반 AI 맞춤 질문 생성</span>
                  </div>
                  <div className={styles.feature}>
                    <span className={styles.featureCheck}>✓</span>
                    <span>STAR 기법 기반 답변 가이드</span>
                  </div>
                  <div className={styles.feature}>
                    <span className={styles.featureCheck}>✓</span>
                    <span>질문당 3개 꼬리질문으로 심층 대비</span>
                  </div>
                </div>
                ...
                <p style={{
                  ...
                  <span style={{ opacity: 0.7, fontSize: '0.8rem' }}>20일이면 면접 준비 끝</span>
                </p>
              </div>
        ...
        <section className={styles.comparison}>
          <div className={styles.comparisonContainer}>
            <div className={styles.sectionHeader}>
              <span className={styles.badge}>ChatGPT vs QueryDaily</span>
              <h2 className={styles.sectionTitle}>
                왜 QueryDaily인가요?
              </h2>
            </div>
            ...
            <div style={{
              ...
              <p style={{fontSize: '1rem', lineHeight: '2', opacity: 0.7, marginBottom: '1.5rem'}}>
                <span style={{opacity: 0.5}}>ChatGPT:</span> 이력서를 모름 → 일반 질문 → 차별화 안 됨<br/>
                <span style={{color: 'var(--color-secondary)', fontWeight: '600'}}>QueryDaily:</span> 이력서 분석 → 맞춤 질문 → 면접관 기억에 남음
              </p>
              <p style={{
                fontSize: '1.1rem',
                fontWeight: '600',
                ...
                면접관이 물을 질문은 <span style={{color: 'var(--color-secondary)'}}>이미 당신 이력서에</span> 있습니다.<br/>
                <span style={{opacity: 0.7, fontWeight: '400'}}>QueryDaily는 그걸 찾아드립니다.</span>
              </p>
            </div>
          </div>
        </section>
        ...
        <section className={styles.bridgeCta} style={{background: '#ffffff'}}>
          <div className={styles.bridgeCtaContainer}>
            <div style={{textAlign: 'center', maxWidth: '600px', margin: '0 auto'}}>
              <h3 style={{
                ...
                <span style={{opacity: 0.5}}>"</span>왜 그 질문이 나올 줄 몰랐지?<span style={{opacity: 0.5}}>"</span>
              </h3>
              ...
              <p style={{
                ...
                실력이 없어서가 아니에요.<br/>
                <strong style={{color: 'var(--color-secondary)'}}>알았다면, 말할 수 있었어요.</strong>
              </p>
              ...
              <a href="#products" style={{
                ...
                textDecoration: 'none',
                boxShadow: '0 8px 30px rgba(220, 38, 38, 0.4)',
                animation: 'ctaPulse 2s ease-in-out infinite, ctaShine 3s linear infinite',
          ...
          <div style={{maxWidth: '1200px', margin: '0 auto'}}>
            ...
            <div style={{
              ...
              <div style={{maxWidth: '400px'}}>
                ...
                <div style={{display: 'flex', gap: '1rem'}}>
                  {/* Threads */}
                  <a
                    href="https://www.threads.net/@querydaily"
                    target="_blank"
                    rel="noopener noreferrer"
                    style={{
                      width: '40px',
                  ...
                  >
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M12.186 24h-.007c-3.581-.024-6.334-1.205-8.184-3.509C2.35 18.44 1.5 15.586 1.472 12.01v-.017c.03-3.579.879-6.43 2.525-8.482C5.845 1.205 8.6.024 12.18 0h.014c2.746.02 5.043.725 6.826 2.098 1.677 1.29 2.858 3.13 3.509 5.467l-2.04.569c-1.104-3.96-3.898-5.984-8.304-6.015-2.91.022-5.11.936-6.54 2.717C4.307 6.504 3.616 8.914 3.589 12c.027 3.086.718 5.496 2.057 7.164 1.43 1.783 3.631 2.698 6.54 2.717 2.623-.02 4.358-.631 5.8-2.045 1.647-1.613 1.618-3.593 1.09-4.798-.31-.71-.873-1.3-1.634-1.75-.192 1.352-.622 2.446-1.284 3.272-.886 1.102-2.14 1.704-3.73 1.79-1.202.065-2.361-.218-3.259-.801-1.063-.689-1.685-1.74-1.752-2.96-.065-1.17.408-2.133 1.37-2.788.812-.554 1.897-.85 3.14-.86.88-.006 1.7.087 2.45.279-.034-.78-.177-1.396-.43-1.846-.324-.575-.865-.893-1.65-.969v-.01c-.09-.01-.18-.013-.27-.013-1.2 0-2.029.467-2.532 1.428l-1.73-1.025c.808-1.543 2.235-2.358 4.13-2.358l.165.002c1.627.072 2.905.681 3.8 1.81.746.943 1.144 2.205 1.183 3.752.532.135 1.015.308 1.447.526 1.07.54 1.897 1.33 2.46 2.35.758 1.372.896 3.373-.339 5.087-1.74 2.417-4.452 3.178-7.594 3.2zm-1.378-7.2c-.756.057-1.353.243-1.73.54-.323.254-.456.54-.433.93.043.762.699 1.467 1.985 1.397 1.09-.06 1.913-.472 2.449-1.225.364-.511.603-1.16.717-1.942-.86-.177-1.8-.26-2.746-.26-.08 0-.16.002-.242.005z"/>
                    </svg>
                  </a>
                  {/* Velog */}
                  <a
                    href="https://velog.io/@querydaily"
                    target="_blank"
                    rel="noopener noreferrer"
                    style={{
                      width: '40px',
            ...
            <div style={{
              ...
              <p style={{
                ...
                fontSize: '0.8rem',
                color: 'var(--color-text-muted)'
              }}>© 2025 QueryDaily. All rights reserved.</p>
              <p style={{
                margin: 0,
                fontSize: '0.8rem',
                color: 'var(--color-text-muted)'
              }}>사업자등록번호: 456-12-02771 | 대표: 어싱크사이트</p>
            </div>
          </div>
        </footer>
      </div>
