...
> **중요**: 2025년 11월에 GA4 구현이 완전히 재설계되었습니다.
> 새로운 구현에 대해서는 아래 문서를 먼저 참조하세요.

### 👉 **[GA-REDESIGN-SUMMARY.md](./GA-REDESIGN-SUMMARY.md)** ⭐ 필독!

주요 변경사항:
- 전체 코드 구조 재설계 (`/lib/analytics/`, `/components/analytics/`, `/hooks/`)
- `purchase_source` 파라미터로 랜딩 vs 상세페이지 구매 전환율 비교
