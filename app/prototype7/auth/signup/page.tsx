...
export default function SignUpPageV7() {
  return (
    <div className="px-6 py-12 min-h-screen">
      <div className="mb-12">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">회원가입</h1>
        <p className="text-gray-500">매일 성장하는 여정을 시작하세요</p>
      </div>
      ...
      <Link
        ...
        className="block w-full py-3 bg-gradient-to-r from-emerald-500 to-teal-500 text-white text-center rounded-xl font-medium hover:shadow-lg transition-all mb-6"
      >
        가입하고 시작하기
      </Link>
