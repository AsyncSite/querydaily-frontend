    ...
    return (
      <div className={styles.container}>
        <div className={styles.notFound}>
          <h1>상품을 찾을 수 없습니다</h1>
          <button onClick={() => router.push('/v2')} className={styles.backBtn}>
            메인으로 돌아가기
          </button>
        </div>
      </div>
    ...
    <div className={styles.container}>
      ...
      <header className={styles.header}>
        <div className={styles.headerContainer}>
          <div className={styles.logo} onClick={() => router.push('/v2')}>
      ...
      <section className={styles.productHero}>
        <div className={styles.productHeroContainer}>
          <div className={styles.productInfo}>
            ...
            <p className={styles.productNameEn}>{product.nameEn}</p>
            ...
            >
              {product.available ? '구매하기' : '준비 중'}
            </button>

            <div className={styles.policies}>
              <p>• 기간: {product.period}</p>
              <p>• 환불: {product.refund}</p>
            </div>
          </div>
          ...
          <div className={styles.howItWorksContainer}>
            ...
            <div className={styles.workflowSteps}>
              ...
              <div className={styles.workflowStep}>
                ...
                <div className={styles.stepContent}>
                  <h3 className={styles.stepTitle}>🤖 질문 생성</h3>
                  <p className={styles.stepDescription}>
            ...
            <div className={styles.exampleEmail}>
              <h3 className={styles.exampleTitle}>📮 질문 이메일 예시</h3>
            ...
            {/* 답변 가이드 이메일 예시 */}
            <div className={styles.exampleEmail}>
              <h3 className={styles.exampleTitle}>📮 답변 가이드 이메일 예시</h3>
              <div className={styles.emailPreview}>
                <div className={styles.emailHeader}>
                  <div className={styles.emailSubject}>
                ...
                <div className={styles.emailBody}>
                  ...
                  <p className={styles.sectionContent}>
                    <strong>질문 유형:</strong> 경험 연결형(🔗) + 한계 돌파형(🚀)
                    <br/><br/>
      ...
      {productId === 'critical-hit' && (
        <section className={styles.howItWorks}>
          <div className={styles.howItWorksContainer}>
            <h2 className={styles.sectionTitle}>어떻게 제공되나요?</h2>
            <p className={styles.howItWorksIntro}>
              결제 즉시 3개의 핵심 질문과 각각의 프리미엄 답변 가이드가 이메일로 전송됩니다.
            </p>
            ...
            <div className={styles.workflowSteps}>
              <div className={styles.workflowStep}>
                ...
                <div className={styles.stepContent}>
                  <h3 className={styles.stepTitle}>📄 이력서 분석</h3>
                  <p className={styles.stepDescription}>
                    결제 후 업로드한 이력서를 AI가 즉시 분석합니다.<br/>
              ...
              <div className={styles.workflowStep}>
                <div className={styles.stepNumber}>2</div>
                <div className={styles.stepContent}>
                  <h3 className={styles.stepTitle}>🎯 핵심 질문 3개 생성</h3>
                  <p className={styles.stepDescription}>
              ...
              <div className={styles.workflowStep}>
                <div className={styles.stepNumber}>3</div>
                <div className={styles.stepContent}>
                  <h3 className={styles.stepTitle}>📚 프리미엄 답변 가이드 제공</h3>
                  <p className={styles.stepDescription}>
              ...
              <div className={styles.workflowStep}>
                <div className={styles.stepNumber}>4</div>
                <div className={styles.stepContent}>
                  <h3 className={styles.stepTitle}>📧 즉시 이메일 발송</h3>
                  <p className={styles.stepDescription}>
                    결제 완료 후 5분 이내에 3개의 질문과 답변 가이드가 모두 이메일로 발송됩니다.<br/>
                    별도의 대기 시간 없이 바로 학습을 시작할 수 있습니다.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className={styles.exampleEmail}>
              ...
              <div className={styles.emailPreview}>
                <div className={styles.emailHeader}>
                  ...
                  <div className={styles.emailTime}>결제 후 즉시 발송</div>
                </div>
                <div className={styles.emailBody}>
      ...
      <section className={styles.footerCta}>
        <div className={styles.footerCtaContainer}>
          <h2>지금 바로 시작하세요</h2>
          <p>{product.name}으로 면접 준비의 부담을 덜어보세요</p>
          <button
            className={styles.purchaseBtn}
            disabled={!product.available}
          >
